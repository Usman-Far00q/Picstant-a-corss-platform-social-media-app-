...
import 'package:picstant/models/user.dart';
import 'package:picstant/pages/activity_feed.dart';
import 'package:picstant/pages/profile.dart';
import 'package:picstant/pages/search.dart';
import 'package:picstant/pages/timeline.dart';
import 'package:picstant/pages/upload.dart';
import 'dart:io';
...
class _HomeState extends State<Home> {
  ...
  void initState() {
    ...
    googleSignIn.onCurrentUserChanged.listen((account) {
      ...
      print('sum went roong $err');
    });
    // reautheticate user when app is opened
    googleSignIn.signInSilently(suppressErrors: false).then((account) {
      handleSignIn(account);
    }).catchError((err) {
      print('waaat sum went roooongs $err');
    });
  }
...
getiOSPermission(){
  ...
  createUserInFireStore() async {
    // check if user exists in users collection , in the database according to their Id
    final GoogleSignInAccount user = googleSignIn.currentUser;
    DocumentSnapshot doc = await usersRef.document(user.id).get();
    // if the user oesnt exist , then we want tot ake them to the create account page
    if (!doc.exists) {

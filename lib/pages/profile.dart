...
import 'package:picstant/widgets/post_tile.dart';
...
class _ProfileState extends State<Profile> {
  ...
  buildProfileButton() {
    // view our own profile then show edit profile button
  ...
  handleFollowUser() {
    ...
    //Make auth USer a follower of ThAt user (update THEIR followers collection)
    followersRef
        .document(widget.profileId)
        .collection('userFollowers')
        .document(currentUserId)
    ...
    followingRef
        ...
        .document(widget.profileId)
        .setData({});
    //add activity feed item for that user to notify about new follower(use)
    activityFeedRef
        .document(widget.profileId)
        .collection('feedItems')
        .document(currentUserId)
